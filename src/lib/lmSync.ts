...
export async function syncAllAccounts(params: {
  ...
  let merged = mapped.map(a => {
    ...
    return {
      ...
      institutionLogoUrl: ex.institutionLogoUrl,
      institutionLogoDataUrl: ex.institutionLogoDataUrl,
      institutionPrimaryColor: ex.institutionPrimaryColor,
      logoSource: ex.logoSource,
